...
import MyComponent, {getFileName, getExtensionFromType} from 'index';
...
describe('Filename manipulation', () => {
    ...
    test('Retrieves filename by removing file extension if exists...', () => {
        ...
        expect(getFileName('blob_http___localhost_8887_b252abdc-926c-4f8d-82c0-e99671e7bf59'))
